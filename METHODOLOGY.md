...
Together you should reach 80–200 items for a meaningful per-week run.
...
- **Inter-rater agreement** between human annotators on a 10–20%
...
- **Monthly extension** — add 5–10 new test items based on the previous
